...
urlpatterns = [
    ...
    path('groups/<int:group_id>/sessions/<int:session_id>/add-expense/', expense_views.add_expense, name='add_expense'),
    ...
    path('expenses/<int:expense_id>/update/', expense_views.update_expense, name='update_expense'),
